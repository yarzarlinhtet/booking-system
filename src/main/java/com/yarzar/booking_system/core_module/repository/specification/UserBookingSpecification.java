...
public class UserBookingSpecification {
    public static Specification<ClassBooking> hasUser(String email) {
        return (root, query, cb) -> email == null ? null : cb.equal(root.get("user").get("email"), email);
    }

    public static Specification<ClassBooking> hasUser(UUID userId) {
